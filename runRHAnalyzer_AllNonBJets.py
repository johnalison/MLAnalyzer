...
inputFiles_ = ['file:%s'%path for path in glob('/eos/uscms/store/user/jda102/AODSIM//NonB_Pt_30_70_13TeV_TuneCUETP8M1_noPU_AODSIM/181020_000214/0000/step_AODSIM_*root')]
outputDir = "/eos/uscms/store/user/jda102/"

listname = 'list_nonB.txt'
...
cmd="cmsRun %s inputFiles_load=%s maxEvents=%d skipEvents=%d outputFile=%s/IMGs/%s_IMG.root"%(cfg,listname,maxEvents_,skipEvents_,outputDir,"NonBJetNew")
#print '%s'%cmd
os.system(cmd)
