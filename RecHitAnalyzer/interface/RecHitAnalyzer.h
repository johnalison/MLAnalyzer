...
//class RecHitAnalyzer : public edm::EDAnalyzer  {
  ...
  private:
    ...
    const reco::GenParticle* getTruthParticle(const reco::PFJetRef& recJet, edm::Handle<reco::GenParticleCollection> genParticles, float dRMatch = 0.4 , bool debug =false );
